...
Join the OneMed Sign Discord server to:

- Ask questions and get help from the community
- Share feedback and feature requests
- Connect with other OneMed Sign users
...
Paid plans include access to direct support from the OneMed Sign team.
...
- Email support at support@onemed.com.sg
- Account and billing assistance
- Technical guidance for OneMed Sign Cloud usage
- Response during business hours

</Tab>
<Tab value="Platform and Above">

Available on [Platform plans](https://onemed.com.sg/platform-cta-pricing) and above:

- All standard support channels
- Private Discord channel for direct communication with the OneMed Sign team
...
Contact [sales](https://onemed.com.sg/enterprise) for Enterprise support options.
...
<Callout type="info">
  ...
  [sales](https://onemed.com.sg/enterprise) for details.
</Callout>
...
- Guidance on OneMed Sign features and functionality
...
<Callout type="info">
  ...
  available separately. Contact [sales](https://onemed.com.sg/sales) for details.
</Callout>
...
For billing disputes or account issues, email support@onemed.com.sg with your account details.
...
OneMed Sign follows responsible disclosure practices. Security researchers who report valid vulnerabilities responsibly will be acknowledged.

## Contact

| Purpose          | Contact                                                        |
| ---------------- | -------------------------------------------------------------- |
| General support  | support@onemed.com.sg                                          |
| Security issues  | security@onemed.com.sg                                         |
| Enterprise sales | [sales@onemed.com.sg](https://onemed.com.sg/enterprise)           |
| Privacy requests | privacy@onemed.com.sg                                          |
| Community        | [Discord](https://onemed.com.sg/discord)                          |
...
- [Privacy Policy](/docs/policies/privacy) - How OneMed Sign handles your data
