...
description: The open-source version of OneMed Sign, available under the AGPL-3.0 license. Includes core document signing functionality and can be self-hosted.
---
...
| Action             | Description                                                   |
| ------------------ | ------------------------------------------------------------- |
| **Use**            | Run OneMed Sign for any purpose, including commercial use       |
...
<Accordions type="multiple">
  <Accordion title="Source Code Disclosure">
    If you modify OneMed Sign and make it available over a network, you must:
    ...
    <Callout type="warn">
      ...
      OneMed Sign instance over a network (whether internal or external), you must provide them access to
      the source code.
    </Callout>
  ...
  <Accordion title="License Continuity">
    ...
    - Combined works that incorporate OneMed Sign code are subject to AGPL-3.0
...
The Community Edition includes the core OneMed Sign functionality:
...
<Accordions type="multiple">
  <Accordion title="Discord">
    The OneMed Sign Discord server is the primary community support channel. You can:
...
<Callout type="info">
  Community support is provided on a best-effort basis by volunteers and OneMed Sign team members. For
  guaranteed response times and dedicated support, consider the Enterprise Edition.
</Callout>

## Contributing Back

Contributions to OneMed Sign are welcome and appreciated. You can contribute in several ways:

<Accordions type="multiple">
  <Accordion title="Code Contributions">
    1. Fork the [OneMed Sign repository](https://github.com/documenso/documenso)
