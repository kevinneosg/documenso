...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organisations to integrate OneMed Sign into proprietary products.
---
...
- **Build proprietary products**: Integrate OneMed Sign into commercial software without releasing source code
...
- **Need to keep modifications private**: Any changes to OneMed Sign source code that you don't want to disclose

<Callout type="info">
  If you run OneMed Sign without modifications, or your modifications are open source under AGPL-3.0,
...
| SaaS product using OneMed Sign API only        | Community Edition  |
| SaaS product with modified OneMed Sign code    | Enterprise Edition |
...
<Accordions type="multiple">
  <Accordion title="License Rights">
    ...
    - **Proprietary integration**: Embed OneMed Sign in closed-source products without licensing conflicts.
    - **Sublicensing options**: Distribute OneMed Sign as part of your product to your customers (terms vary by agreement).
  ...
  <Accordion title="License Setup">
    1. Acquire a license by contacting [sales](https://onemed.com.sg/enterprise)
    2. Access your license key at [license.onemed.com.sg](https://license.onemed.com.sg)
    ...
    4. Restart your OneMed Sign instance
...
<Accordions type="multiple">
  <Accordion title="Grant of License">
    The Enterprise license is a commercial agreement between your organisation and OneMed Sign. Key terms include:

    - **Scope**: License to use, modify, and distribute OneMed Sign as specified in your agreement
    - **Exclusions**: The license does not grant rights to OneMed Sign trademarks beyond what's specified
  ...
  <Accordion title="What the License Does Not Cover">
    ...
    - OneMed Sign Cloud service (separate subscription)
...
| Factor              | Description                         |
| ------------------- | ----------------------------------- |
| **Deployment type** | Self-hosted or OneMed Sign Cloud      |
...
Contact [sales](https://onemed.com.sg/enterprise) for current pricing. Enterprise agreements typically include:
...
<Steps>
  ...
  <Step>
    ...
    - Email: [sales@onemed.com.sg](https://onemed.com.sg/enterprise)
  ...
  <Step>
    ...
    Options for evaluating OneMed Sign before purchase:
  ...
  <Step>
    ...
    3. Deploy using [self-hosting guides](/docs/self-hosting) or access OneMed Sign Cloud
...
<Accordions type="multiple">
  ...
  <Accordion title="Does the Enterprise license include OneMed Sign Cloud?">
  ...
  <Accordion title="Is there a trial period?">
    Contact [sales](https://onemed.com.sg/enterprise) to discuss evaluation options for your
    organisation.
  </Accordion>
</Accordions>
