---
title: GDPR
description: Understand how OneMed Sign handles GDPR compliance for data processing and storage.
---
...
When using OneMed Sign for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using OneMed Sign) determine the purposes and means of processing |
| **Data Processor**  | OneMed Sign processes personal data on your behalf according to your instructions       |
...
As the data processor, OneMed Sign:
...
OneMed Sign processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use OneMed Sign:

<Tabs items={['OneMed Sign Cloud', 'Self-Hosted']}>
<Tab value="OneMed Sign Cloud">
...
Contact OneMed Sign for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host OneMed Sign:

- You control all data storage locations
- No data is transmitted to OneMed Sign's infrastructure
...
- Export user and document data from your OneMed Sign account
- Delete user accounts and associated documents
- Contact OneMed Sign support for assistance with cloud-hosted data

## Data Deletion

OneMed Sign supports data deletion to help fulfill erasure requests:
...
Self-hosting OneMed Sign can simplify GDPR compliance:
...
- Contact [support@onemed.com.sg](mailto:support@onemed.com.sg) to request a DPA
- The DPA covers OneMed Sign's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with OneMed Sign is required since no personal data is processed by OneMed Sign.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use OneMed Sign, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy OneMed Sign on your own infrastructure
