...
description: Sign up for OneMed Sign and configure your profile.
---
...
See the [pricing page](https://onemed.com.sg/pricing) for feature details and limits.
...
Navigate to [onemed.com.sg/free](https://onemed.com.sg/free) to create a free account. To start with a paid plan, visit the [pricing page](https://onemed.com.sg/pricing) and select your plan.
...
Check your inbox for a verification email and click the confirmation link. The email is sent from `noreply@onemed.com.sg`.
...
For custom branding, team collaboration, API access, and other advanced features, you'll need a paid plan. Explore the [pricing page](https://onemed.com.sg/pricing) and choose the plan that fits your needs.
...
<Steps>
  <Step>
    ...
    ![OneMed Sign account security page showing security options](/get-started-images/documenso-account-security-page.webp)
