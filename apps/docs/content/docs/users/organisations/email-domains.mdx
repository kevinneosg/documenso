---
title: Email Domains
description: Learn how to create and manage email domains in OneMed Sign.
---
...
Email Domains allow you to send emails to recipients from your own domain instead of the default OneMed Sign email address.
...
- Access to your OneMed Sign organisation as an admin or manager
...
After adding your domain, OneMed Sign will provide you with the following required DNS records that need to be configured on your domain:
...
Once you've added the DNS records, return to the OneMed Sign email domains settings page and click the "Verify" button.
