...
description: Upload documents to OneMed Sign to prepare them for signing. Covers supported formats, file size limits, and upload methods.
---
...
<Callout type="warn">
  OneMed Sign does not support password-protected or encrypted PDF files. Remove encryption before
  uploading.
</Callout>
...
<Steps>
  <Step>
    ...
    Open your [Documents dashboard](https://app.onemed.com.sg/documents).
...
1. **Processing**: OneMed Sign validates the PDF and extracts page information
