...
- **Create one automatically**: OneMed Sign creates a new "Direct Link Recipient" for you
...
```
https://app.onemed.com.sg/d/<unique-token>
```
...
If the recipient has a OneMed Sign account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public OneMed Sign profile:
...
![OneMed Sign profile with direct links](/direct-links/documenso-profile.webp)
...
```html
<a href="https://app.onemed.com.sg/d/your-token">Sign our agreement</a>
```
