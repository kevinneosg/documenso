...
description: Integrate OneMed Sign into your applications using the REST API, webhooks, and embedding options.
---
...
```
https://app.onemed.com.sg/api/v2
```
...
<Cards>
  ...
  <Card
    title="Self-Hosting"
    description="Deploy your own OneMed Sign instance."
