---
title: Manual Setup
description: Manually set up OneMed Sign on your machine for local development.
---
...
Follow these steps to set up OneMed Sign on your local machine:
...
Fork the [OneMed Sign repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
Access the OneMed Sign application by visiting `http://localhost:3000` in your web browser.
