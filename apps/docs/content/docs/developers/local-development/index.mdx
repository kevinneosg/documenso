...
description: Learn how to set up OneMed Sign for local development.
---

## Overview

There are multiple ways of setting up OneMed Sign for local development. At the moment of writing this documentation, there are 3 ways of running OneMed Sign locally:
...
<div className="mt-16 flex items-center justify-center gap-4">
  <a href="https://onemed.com.sg/discord">
    <img
      src="https://img.shields.io/badge/Discord-onemed.com.sg/discord-%235865F2"
      alt="Join OneMed Sign on Discord"
    />
  </a>
...
- [Contributing](/docs/developers/contributing) - Learn how to contribute to OneMed Sign
