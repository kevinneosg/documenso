...
In addition to embedding signing, OneMed Sign supports embedded authoring. It allows your users to create and edit documents, templates, and envelopes without leaving your application.

<Callout type="warn">
  Embedded authoring is included with [Enterprise](https://onemed.com.sg/enterprise-cta) plans. It is
  also available as a paid add-on for the [Platform Plan](https://onemed.com.sg/platform-cta-pricing).
...
This endpoint requires your OneMed Sign API key. The token has a default expiration of 1 hour.

See the [API documentation](https://openapi.onemed.com.sg/reference#tag/embedding) for full details.
