...
OneMed Sign offers two types of embedding:
...
The [Platform Plan](https://onemed.com.sg/platform-cta-pricing) adds enhanced customization:

- Custom CSS and styling variables
- Dark mode controls
- Removal of OneMed Sign branding
...
<Steps>
<Step>
Navigate to your team's templates in OneMed Sign
...
For example, `https://app.onemed.com.sg/d/-WoSwWVT-fYOERS2MI37k` has the token `-WoSwWVT-fYOERS2MI37k`.
...
| `host`                | `string`   | OneMed Sign instance URL. Defaults to `https://app.onemed.com.sg`. |
