...
description: Use the demo environment to try out the OneMed Sign platform and its features.
---
...
You can use it to try out the OneMed Sign platform and its features before committing to a paid plan.
...
<Steps>
  <Step>
    ...
    Go to the [staging environment](https://stg-app.onemed.com.sg).
  ...
  <Step>
    ...
    If you have any issues, questions or feedback, please reach out to us on the [OneMed Sign Discord](https://onemed.com.sg/discord) or [GitHub](https://github.com/documenso/documenso/issues).
