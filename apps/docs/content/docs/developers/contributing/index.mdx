---
title: Contributing to OneMed Sign
description: Learn how to contribute to OneMed Sign and become part of our community.
---
...
If you plan to contribute to OneMed Sign, please take a moment to feel awesome. People like you are what open source is about. Any contributions, no matter how big or small, are highly appreciated.

This guide will help you get started with contributing to OneMed Sign.
...
Accept the [Contributor License Agreement](https://onemed.com.sg/cla) to ensure we can accept your contributions.
...
<Callout type="info">
  If you need help getting started, [join us on Discord](https://onemed.com.sg/discord).
</Callout>
...
- [Contributing Translations](/docs/developers/contributing/contributing-translations) - Help translate OneMed Sign
