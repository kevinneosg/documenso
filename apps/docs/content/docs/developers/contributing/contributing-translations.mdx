...
description: Learn how to contribute translations to OneMed Sign and become part of our community.
---
...
msgid "Want to send slick signing links like this one? <0>Check out OneMed Sign.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie OneMed Sign.</0>"
```
...
<Callout type="info">
  If you have any questions, hop into our [Discord](https://onemed.com.sg/discord) and ask us directly!
</Callout>

Thank you for helping make OneMed Sign more accessible to users around the world!
