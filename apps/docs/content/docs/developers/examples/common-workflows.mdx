...
Register your endpoint in the OneMed Sign dashboard:
...
class OneMed SignApiError extends Error {
  code?: string;
  statusCode: number;
  details?: Record<string, unknown>;
...
try {
  ...
  if (error instanceof OneMed SignApiError) {
...
- [API Reference](https://openapi.onemed.com.sg/) - Full endpoint documentation
