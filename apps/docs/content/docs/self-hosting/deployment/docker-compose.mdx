...
description: Deploy OneMed Sign with Docker Compose, including PostgreSQL. This production-ready setup is suitable for most self-hosted deployments.
---
...
The OneMed Sign container waits for the database health check to pass before starting.
...
# Public URL where OneMed Sign is accessible
...
For production, place OneMed Sign behind a reverse proxy for SSL termination:
