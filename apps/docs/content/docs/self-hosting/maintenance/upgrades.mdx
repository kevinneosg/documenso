---
title: Upgrades
description: Upgrade your self-hosted OneMed Sign installation to get the latest features, security patches, and bug fixes.
---
...
OneMed Sign follows [Semantic Versioning](https://semver.org/):
...
Check your running OneMed Sign version:
...
OneMed Sign runs database migrations automatically when the container starts. No manual intervention is required.
