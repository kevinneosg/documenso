...
description: Diagnose and resolve common issues with your self-hosted OneMed Sign instance, organized by component.
---
...
OneMed Sign exposes a health endpoint to verify the application is running:
...
<Steps>
  ...
  <Step>
    Change OneMed Sign's port mapping: `-p 3001:3000`
  </Step>
</Steps>
...
```
  ...
  <Step>
    Update the certificate file and restart OneMed Sign
  </Step>
</Steps>
...
- **[Discord](https://onemed.com.sg/discord)**: Join the OneMed Sign community Discord
...
For security vulnerabilities, do not open a public issue. Contact security@onemed.com.sg directly.
