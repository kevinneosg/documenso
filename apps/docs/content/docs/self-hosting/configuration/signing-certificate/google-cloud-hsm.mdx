...
Create a service account with the `cloudkms.signerVerifier` role so OneMed Sign can use the key.

</Step>
<Step>
### Export public certificate

Export the public certificate from the HSM key; OneMed Sign needs it to embed in signatures.
