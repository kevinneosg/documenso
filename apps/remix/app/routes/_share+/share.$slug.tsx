...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'OneMed Sign - Share' },
    { description: 'I just signed a document in style with OneMed Sign!' },
    {
      property: 'og:title',
      content: 'OneMed Sign - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with OneMed Sign!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for OneMed Sign.
  throw redirect('https://onemed.com.sg');
};
